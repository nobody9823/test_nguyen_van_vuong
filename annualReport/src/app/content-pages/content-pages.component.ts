...
export class ContentPagesComponent {
  ...
  navList = [
    ...
    },
    {
      ...
      children: [
        { title: 'Triển vọng Đường thế giới', navId: 'section2' },
        { title: 'Triển vọng Đường Việt Nam', navId: 'section3' },
        { title: 'Thị trường Thực phẩm và Đồ uống (F&B) - Tiềm năng và cơ hội', navId: 'section4' },
        { title: 'Tận dụng lợi thế cạnh tranh, bứt phá trên phạm vi toàn cầu', navId: 'section5' },
        { title: 'Giới thiệu Ban Tổng Giám đốc', navId: 'header-nav-6' },
        { title: 'Báo cáo của Ban Tổng Giám đốc về hoạt động trong năm', navId: 'header-nav-6-2' },
        { title: 'Thông tin cổ phiếu', navId: 'section7' },
        { title: 'Hoạt động thị trường vốn', navId: 'header-nav-8_2' },
        { title: 'Tình hình đầu tư phát triển công nghệ, nâng cao hiệu quả hoạt động', navId: 'header-nav-8' },
        { title: 'Mô hình vận hành tiên phong - Lộ trình số hóa chuyển đổi doanh nghiệp mạnh mẽ', navId: 'header-nav-8_1' },
        { title: 'Quản lý hiệu quả chuỗi cung ứng', navId: 'section10' },
        { title: 'Hoạt động R&D tích cực trong niên độ 2022-2023', navId: 'section13' },
        { title: 'Hoạt động của công ty con - công ty liên kết', navId: 'section15' },
        { title: 'Đảm bảo chất lượng và nhận xét của Khách hàng về chất lượng về chất lượng sản phẩm ', navId: 'section16' },
        { title: 'Viện Nghiên cứu Nông nghiệp Thành Thành Công - Bước tiến quan trọng trong chiến lược xây dựng vùng nguyên liệu bền vững', navId: 'section18' },
        { title: 'Đồng hành cùng Khách hàng doanh nông trên mỗi chặng đường', navId: 'section19' },
        { title: 'Chia sẻ của Khách hàng doanh nông và Cán bộ nhân viên Khuyến nông', navId: 'section20' },
        { title: 'Nhân sự và đào tạo', navId: 'section21' },
        { title: 'Chia sẻ của Nhân viên', navId: 'section22' },
      ],
    },
    {
      index: 5,
