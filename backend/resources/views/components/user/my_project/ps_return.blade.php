    ...
    <div class="ps_plan_form_wrapper">
        <div class="ps_plan_form_item">
            ...
            <div class="spinner-wrapper">
                ...
                <p class="saved_icon" aria-hidden="true" style="display: none;" id="saved_reward_by_total_amount">保存しました</p>
        ...
        <div class="ps_plan_form_item">
            ...
            <div class="spinner-wrapper">
                ...
                <p class="saved_icon" aria-hidden="true" style="display: none;" id="saved_reward_by_total_quantity">保存しました</p>
