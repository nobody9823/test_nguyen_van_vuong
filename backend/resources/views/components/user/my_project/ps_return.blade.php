<form action="{{ route('user.my_project.project.update', ['project' => $project, 'current_tab' => 'ps_return']) }}" method="post">
    ...
    <div class="ps_plan_form_wrapper">
        <div class="ps_plan_form_item">
            <div class="form_item_tit">支援総額順PSリターン<span class="hissu_txt">必須</span><span style="font-weight: normal;font-size: 1.2rem;">※300文字以内で入力してください</span></div>
        ...
        <div class="ps_plan_form_item">
            <div class="form_item_tit">支援件数順PSリターン<span class="hissu_txt">必須</span><span style="font-weight: normal;font-size: 1.2rem;">※300文字以内で入力してください</span></div>
