    ...
    <div class="card-header d-flex align-items-center">
        ...
        @elseif ($role !== 'admin')
            @if ($project->release_status === '---' || $project->release_status === "差し戻し" || $project->release_status === "掲載停止中")
                <a href="{{ route($role.'.project.approval_request', ['project' => $project]) }}" class="btn btn-primary btn-approval-request">承認申請を行う</a>
            @endif
        @endif
                            ...
                            <div class="card-header d-flex align-items" id="projectDetailHeader">
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="{{ route($role.'.project.edit', compact('project')) }}"
                                        class="btn btn-primary mr-3">編集</a>
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <h3>支援者総数 : </h3>
                                                    <h5 class="mb-3">{{ $project->getCheeringUsersCount() }}人</h5>
                                                    <h3>支援金総額 : </h3>
                                                ...
                                                <div class="card border-secondary" style="border-width: thick">
                                                    ...
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item d-flex">
                                                            <h5 class="font-weight-bold mb-1 flex-grow-1">{{ $plan->title }}</h5>
                                                            @if ($project->release_status !== '掲載中' && $project->release_status !== '承認待ち' || $role === "admin")
                                                            <div class="text-right">
                        ...
                        <div class="card border-info">
                            <div class="card-header d-flex align-items" id="activityReportHeader">
                                <a class="btn btn-link" data-toggle="collapse" data-target="#activityReportBody"
                                        aria-expanded="true" aria-controls="activityReportBody"><h5
                                        class="flex-grow-1">活動報告▼</h5></a>
                                <div class="text-right">
                                </div>
                            </div>
                        ...
                        <div class="card border-info">
                                <div class="card-header flex-grow-1" id="cheeringUsersListHeader">
                                    <a class="btn btn-link" data-toggle="collapse" data-target="#cheeringUsersListBody"
                                        aria-expanded="true" aria-controls="cheeringUsersListBody"><h5
                                        class="flex-grow-1">支援者一覧▼</h5></a>
                                </div>
                            <div id="cheeringUsersListBody" class="collapse"
                                aria-labelledby="cheeringUsersListHeader" data-parent="#projectDetail">
                                <div class="card-body">
                                        <form action="{{ route($role.'.project.mail.create_cheering_users_mail', ['project' => $project]) }}" method="get">
                                            @csrf
                                            <button type="submit" id="btn-send-cheering-users" class="btn btn-warning">メール送信</button>
                                    ...
                                    {{-- <a href="{{ route($role.'.project.output_cheering_users_to_csv', compact('project')) }}" class="btn btn-secondary" type="submit" >支援者一覧をCSV出力</a> --}}
                                </div>
                            </div>
                        </div>
