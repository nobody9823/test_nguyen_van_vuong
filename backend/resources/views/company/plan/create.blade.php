...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('company.plan.store', ['project' => $project]) }}" enctype="multipart/form-data"
            method="POST">
            @csrf
            
            <x-manage.plan.form guard="company" :project="$project" :plan="null" :contribution="$contribution"/>
