    ...
    <div class="card-body">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-end mb-3">
                <form class="m-2"
                    action="{{ route('company.temporary_talent.accept', ['temporary_talent' => $temporary_talent]) }}"
                    method="post">
                    @csrf
                    @method('POST')
                ...
                <form class="m-2"
                    action="{{ route('company.temporary_talent.reject', ['temporary_talent' => $temporary_talent]) }}"
                    method="post">
                    @csrf
                    @method('DELETE')
