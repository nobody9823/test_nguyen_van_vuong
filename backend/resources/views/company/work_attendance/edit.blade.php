    ...
    <div class="flex-grow-1">
        ...
        <div>
            <form class="mb-2 mt-2"
                action={{ route("company.work_shift.edit",['talent' => $work_shifts->first()->talent]) }}>
...
<x-manage.work_shift.translate_month guard='company' model='work_attendance' :talent="$work_shifts->first()->talent"
    :targetMonth="$target_month" />

<x-manage.work_shift.attendance_edit :totals="$totals" guard='company' :workShifts="$work_shifts"
    :targetMonth="$target_month" />
