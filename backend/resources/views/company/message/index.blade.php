                    ...
                    <div class="ml-2">
                        <div class="justify-content-center mt-3 p-3" style="background-color: #eee">
                            <div class="col-sm-12 p-2 bg-light d-flex align-items-center justify-content-between">
                                ...
                                <form class="text-right" action={{route('company.message.index')}} method="get">
                                    <input name="message_word" type="text" placeholder="プラン名、ユーザー名で検索"
                                        class="my_search_input" style="line-height: 2.0;"
                                        value={{Request::get('message_word')}}>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-4 chat_group_list" style="height:100vh; overflow-y:scroll;">
                                    ...
                                    <p style='background-color:rgb(182, 182, 182);margin:10px 0px 0 0;'>ダイレクトメッセージ中支援プラン</p>
                                    @endif
                                    @foreach ($chating_messages as $message)
                                    <x-common.message.a_message_of_index :message="$message" guard='company'
                                    ...
                                    <p style='background-color:rgb(182, 182, 182);margin:10px 0px 0 0;'>ダイレクトメッセージしていない支援プラン
                                    </p>
                                    @endif
