        ...
        <div class="prof_page_base">
            ...
            <div class="ps_rank_base">
                ...
                <div class="ps_rank_img m_b_1510">
                    <img class=""
                        src="{{ Storage::url($project->projectFiles()->where('file_content_type', 'image_url')->first()->file_url) }}">
                </div>
                ...
                <div class="ps_rank_02 m_b_4030">
                    ...
                    @endphp
                    @foreach($users_ranked_by_total_quantity as $rank => $project_supporter)
                    @php
                    ...
                    <div class="ps_rank_02_L ranked_inviter_by_amount_list">
                        ...
                        $loop->iteration === 4 || $project_supporter->email === Auth::user()->email || $loop->last)
                        <div
                            ...
                            <div class="ps_rank_item_01">
                                ...
                                <svg version="1.1" id="" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 29.5 21"
                                    style="enable-background:new 0 0 29.5 21; " xml:space="preserve">
                        ...
                        <div class="row justify-content-center mb-5" style="margin-top: 5px;">
                            <button id="ranked_inviter_by_amount_more_looking_button">もっと見る</button>
                            <button id="ranked_inviter_by_amount_closed_button">閉じる</button>
                        </div>
                    </div>
                    <!--/ps_rank_02_L-->
                    ...
                    <div class="ps_rank_02_R ranked_inviter_of_count_list">
                        ...
                        <div class="row justify-content-center mb-5" style="margin-top: 5px;">
                            <button id="ranked_inviter_of_count_more_looking_button">もっと見る</button>
                            <button id="ranked_inviter_of_count_closed_button">閉じる</button>
                        </div>
...
<script type="text/javascript">
    window.addEventListener('DOMContentLoaded', () => {
        moreLooking('ranked_inviter_by_amount',5,30,'ranked_inviter_by_amount_more_looking_button','ranked_inviter_by_amount_closed_button');
        moreLooking('ranked_inviter_of_count',5,30,'ranked_inviter_of_count_more_looking_button','ranked_inviter_of_count_closed_button');
    })
</script>
