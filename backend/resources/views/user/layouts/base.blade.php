...
<head>
    @production
        ...
        <script type="text/javascript">
            ...
            (window, document, "clarity", "script", "a90vi2gpyj");
        </script>
    @endproduction
    <meta charset="utf-8">
    ...
    <link href="{{ asset('css/style.css') }}?20220428" type="text/css" rel="stylesheet">
    @yield('css')
					...
					<p class="nav_btn_tit_L">全てのタグ</p>
                                        ...
                                        @guest('web')
                                            <li class="menu-item nav_btn taso_li menuset_03 login_btn mobile_hide">
                                                <a href="{{ route('login') }}" class="top_menu-1 nav_btn_link">
                                                    <p class="nav_btn_tit_L">クラファンに<br />ログイン</p>
                                                </a>
                                            </li>
                                        ...
                                        @auth('web')
                                            ...
                                            <li class="menu-item nav_btn taso_li menuset_06">
                                                <a href="{{ route('user.my_project.project.index') }}"
                                                    class="top_menu-1 nav_btn_link">
                                                    <p class="nav_btn_tit_L">マイプロジェクト管理</p>
                                                </a>
                                            </li>
                                            <li class="menu-item nav_btn taso_li menuset_06">
                                                <a href="{{ route('user.bank_account.edit') }}"
                                                    class="top_menu-1 nav_btn_link">
                                            ...
                                            <li class="menu-item nav_btn taso_li menuset_06">
                                                <a href="{{ route('user.liked_projects') }}"
                                                    class="top_menu-1 nav_btn_link">
                                        ...
                                        @auth('web')
                                            ...
                                            <li class="menu-item nav_btn taso_li menuset_06">
                                                <form action="{{ route('logout') }}" method="POST">
                                                    @csrf
                                                    <button class="top_menu-1 top_menu_logout"
                                                        type="button">クラファンからログアウト</button>
                                                </form>
                                            </li>
                                            <li class="menu-item nav_btn taso_li menuset_06">
