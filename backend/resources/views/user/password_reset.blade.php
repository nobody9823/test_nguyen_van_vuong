...
@section('jetpack_meta')
    ...
    <meta property="og:description" content="ログイン画面">
            ...
            <div class="fixedcontainer mypage_contents c-password_box">
                ...
                <form action="{{ route('user.password.update', ['token' => $token]) }}" method="POST">
                    ...
                    <div class="form-group user_password">
                        <label class="control-label password" for="user_password_01">メールアドレス
                        </label>
                        <input class="form-control password" placeholder="メールアドレス"
                            type="text" name="email" id="user_password_01" value="{{ old('email') }}">
                    </div>

                    <div class="form-group user_password">
                        <label class="control-label password" for="user_password_02">新しいパスワード
                        </label>
                        <input class="form-control password" placeholder="新しいパスワード" type="password"
                    ...
                    <div class="form-group user_password">
                        ...
                        <input class="form-control password" placeholder="確認用パスワード" type="password"
