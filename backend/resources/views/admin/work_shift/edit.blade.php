    ...
    <div class="flex-grow-1">
        ...
        <div>
            <form class="mb-2 mt-2"
                action={{ route("admin.work_attendance.edit",['talent' => $work_shifts->first()->talent]) }}>
...
<x-manage.work_shift.translate_month guard='admin' model='work_shift' :talent="$work_shifts->first()->talent"
    :targetMonth="$target_month" />

<x-manage.work_shift.shift_edit :totals="$totals" guard='admin' :workShifts="$work_shifts"
    :targetMonth="$target_month" />
