...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('talent.project.update', ['project' => $project]) }}" enctype="multipart/form-data"
            method="POST">
            @csrf
            @method('PUT')
            <x-manage.project.form role="talent" :project="$project" :categories="$categories" />
...
$(function () {
    ...
    $(".del-btn").click(function() {
        ...
        if (deleteConfirm === true) {
            ...
            // ajaxについての記述
            $.ajax({
                url: '/talent/project/image/' + ImageId,
                type: 'POST',
