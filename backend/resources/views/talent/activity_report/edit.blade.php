...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('talent.activity_report.update', ['project' => $project, 'activity_report' => $activity_report]) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            <x-manage.activity_report.form role="talent" :project="$project" :activityReport="$activity_report" />
        </form>
        <div class="row">
...
$(function () {
    ...
    $(".del-btn").click(function() {
        ...
        if (deleteConfirm === true) {
            ...
            // ajaxについての記述
            $.ajax({
                url: '/talent/activity_report/image/' + ImageId,
                type: 'POST',
