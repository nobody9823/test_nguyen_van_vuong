    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('talent.detail.update', compact('detail')) }}" method="POST" enctype="multipart/form-data">
                        @method('PATCH')
                        @csrf
                        ...
                        <div class="form-group">
                            <label>所属企業</label>
                            <div class="dropdown">
                                {{ Form::select('company_id', $companies, old('company_id', $detail->company_id), ['class' => 'form-control']) }}
                            </div>
                        </div>
