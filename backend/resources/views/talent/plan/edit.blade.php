...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('talent.plan.update', ['project' => $project, 'plan' => $plan]) }}"
            enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            
            <x-manage.plan.form guard="talent" :project="$project" :plan="$plan" :contribution="$contribution" />
