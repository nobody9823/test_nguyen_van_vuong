...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_rumble.xml';	
    $db_cache_field = 'rumble-contempo-notifier-cache';
    $db_cache_field_last_updated = 'rumble-contempo-notifier-last-updated';
