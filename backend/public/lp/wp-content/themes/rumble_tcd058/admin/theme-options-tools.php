...
/**
 * Rumble オプションTools デフォルト画像設定フィルター
 */
function rumble_theme_options_tools_get_default_images_settings( $default_images_settings ) {
	// デフォルト画像設定
	return array(
/*
		array(
...
*/
		array(
			'media_filename' => 'rumble-image_300x250.gif',
			'source_filepath' => get_template_directory() . '/admin/img/default/image_300x250.gif',
			'theme_option_keys' => array( "['contents_builder'][2]['cb_ad_image1']", "['contents_builder'][2]['cb_ad_image2']" )
		),
		array(
			'media_filename' => 'rumble-image_468x60.gif',
			'source_filepath' => get_template_directory() . '/admin/img/default/image_468x60.gif',
			'theme_option_keys' => array( 'header_ad_image1', 'header_ad_image2' )
		)
	);
}

/**
 * Rumble オプションTools サンプルカテゴリー
 */
function rumble_theme_options_tools_set_sample_categories( $dp_options ) {
	...
	$media_id_image_megamenu = theme_options_tools_get_media_id( array(
		'media_filename' => 'rumble-image_260x180.gif',
		'source_filepath' => get_template_directory() . '/admin/img/default/image_195x137.gif'
	), true );
...
/**
 * Rumble オプションTools サンプル記事
 */
function rumble_theme_options_tools_set_sample_posts( $dp_options ) {
	// 新規サイト以外、リセットチェックなしの場合は終了
	...
	$media_id = (int) theme_options_tools_get_media_id( array(
		'media_filename' => 'rumble-image_855x600.gif',
		'source_filepath' => get_template_directory() . '/admin/img/default/image_855x600.gif'
	), true );
...
/**
 * Rumble オプションTools サンプルメニュー
 */
function rumble_theme_options_tools_set_sample_menus( $dp_options ) {
	// 新規サイト以外、リセットチェックなしの場合は終了
...
/**
 * Rumble オプションTools サンプルウィジェット
 */
function rumble_theme_options_tools_set_sample_widgets( $dp_options ) {
	// 新規サイト以外、リセットチェックなしの場合は終了
 ...
 * Rumble テーマ初期化フィルター
 */
add_filter( 'tcd_theme_options_tools-get_default_images_settings', 'rumble_theme_options_tools_get_default_images_settings', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'rumble_theme_options_tools_set_sample_categories', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'rumble_theme_options_tools_set_sample_posts', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'rumble_theme_options_tools_set_sample_menus', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'rumble_theme_options_tools_set_sample_widgets', 10, 1 );
