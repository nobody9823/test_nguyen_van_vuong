<?php
global $dp_options, $dp_default_options, $font_type_options, $headline_font_type_options, $responsive_options, $layout_options, $layout_mobile_options, $load_icon_options, $load_time_options, $hover_type_options, $hover2_direct_options, $sns_type_top_options, $sns_type_btm_options, $gmap_marker_type_options, $gmap_custom_marker_type_options;
...
<div class="theme_option_field cf">
	...
	<h4 class="theme_option_headline2"><?php _e( 'PC layout', 'tcd-w' ); ?></h4>
	<ul class="p-layout cf">
		<?php foreach ( $layout_options as $option ) : ?>
		<li>
			<label>
				<input type="radio" name="dp_options[layout]" value="<?php echo esc_attr( $option['value'] ); ?>" <?php checked( $option['value'], $dp_options['layout'] ); ?>>
	...
	<h4 class="theme_option_headline2"><?php _e( 'Mobile layout', 'tcd-w' ); ?></h4>
	<ul class="p-layout cf">
		<?php foreach ( $layout_mobile_options as $option ) : ?>
		<li>
			<label>
				<input type="radio" name="dp_options[layout_mobile]" value="<?php echo esc_attr( $option['value'] ); ?>" <?php checked( $option['value'], $dp_options['layout_mobile'] ); ?>>
				<img src="<?php echo esc_attr( $option['image'] ); ?>" alt="<?php echo esc_attr( $option['label'] ); ?>">
				<?php echo $option['label']; ?>
			</label>
		</li>
...
<div class="theme_option_field cf">
	...
	<ul>
		<li>
			...
			<input class="regular-text" type="text" name="dp_options[facebook_url]" value="<?php echo esc_attr( $dp_options['facebook_url'] ); ?>">
		</li>
		<li>
			<label style="display:inline-block; min-width:140px;"><?php _e('Your Twitter URL', 'tcd-w'); ?></label>
			<input class="regular-text" type="text" name="dp_options[twitter_url]" value="<?php echo esc_attr( $dp_options['twitter_url'] ); ?>">
		</li>
		<li>
			<label style="display:inline-block; min-width:140px;"><?php _e('Your Youtube URL', 'tcd-w'); ?></label>
		...
		<li>
			...
			<input class="regular-text" type="text" name="dp_options[instagram_url]" value="<?php echo esc_attr( $dp_options['instagram_url'] ); ?>">
		</li>
		<li>
			<label style="display:inline-block; min-width:140px;"><?php _e('Your Pinterest URL', 'tcd-w'); ?></label>
			<input class="regular-text" type="text" name="dp_options[pinterest_url]" value="<?php echo esc_attr( $dp_options['pinterest_url'] ); ?>">
		</li>
		<li>
			<label style="display:inline-block; min-width:140px;"><?php _e('Your Contact page URL (You can use contactto:)', 'tcd-w'); ?></label>
			<input id="dp_options[contact_url]" class="regular-text" type="text" name="dp_options[contact_url]" value="<?php echo esc_attr( $dp_options['contact_url'] ); ?>">
		</li>
	</ul>
	<h4 class="theme_option_headline2"><?php _e('Display setting for header SNS button', 'tcd-w'); ?></h4>
	<ul>
		<li><label><input name="dp_options[show_facebook_header]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_facebook_header'] ); ?>> <?php _e('Display Facebook button on header', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_twitter_header]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_twitter_header'] ); ?>> <?php _e('Display Twitter button on header', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_youtube_header]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_youtube_header'] ); ?>> <?php _e('Display Youtube button on header', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_instagram_header]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_instagram_header'] ); ?>> <?php _e('Display Instagram button on header', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_pinterest_header]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_pinterest_header'] ); ?>> <?php _e('Display Pinterest button on header', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_contact_header]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_contact_header'] ); ?>> <?php _e('Display Contact page button on header', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_rss_header]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_rss_header'] ); ?>> <?php _e('Display RSS button on header', 'tcd-w'); ?></label></li>
	</ul>
	<h4 class="theme_option_headline2"><?php _e('Display setting for footer SNS button', 'tcd-w'); ?></h4>
	<ul>
		<li><label><input name="dp_options[show_facebook_footer]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_facebook_footer'] ); ?>> <?php _e('Display Facebook button on footer', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_twitter_footer]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_twitter_footer'] ); ?>> <?php _e('Display Twitter button on footer', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_youtube_footer]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_youtube_footer'] ); ?>> <?php _e('Display Youtube button on footer', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_instagram_footer]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_instagram_footer'] ); ?>> <?php _e('Display Instagram button on footer', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_pinterest_footer]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_pinterest_footer'] ); ?>> <?php _e('Display Pinterest button on footer', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_contact_footer]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_contact_footer'] ); ?>> <?php _e('Display Contact page button on footer', 'tcd-w'); ?></label></li>
		<li><label><input name="dp_options[show_rss_footer]" type="checkbox" value="1" <?php checked( '1', $dp_options['show_rss_footer'] ); ?>> <?php _e('Display RSS button on footer', 'tcd-w'); ?></label></li>
	</ul>
	<input type="submit" class="button-ml ajax_button" value="<?php echo __( 'Save Changes', 'tcd-w' ); ?>">
</div>
<?php // Use OGP tag ?>
