...
<style>
    ...
    .footer_02 .footer_main {
        padding: 50px 0;
    }

    .footer_02 .footer_main_inner {
        width: 100%;
        max-width: 1040px;
        margin: 0 auto;
        padding: 0 20px;
    ...
    .footer_02 .footer_main_01 {
        width: 50%;
        border-right: solid 1px #fff;
        padding: 20px 0 20px 0;
    }

    .footer_02 .footer_main_02 {
        width: 25%;
        border-right: solid 1px #fff;
        padding: 20px 0 20px 20px;
    }

    .footer_02 .footer_main_03 {
        width: 25%;
        padding: 20px 0 20px 20px;
    }

    .footer_02 .footer_tit {
        width: 100%;
        font-size: 16px;
        color: #00AEBD;
        margin: 0 0 20px 0;
    ...
    .footer_02 .footer_item {
        margin: 0 0 15px 0;
    }

    .footer_02 .footer_under {
        background: #fff;
        padding: 20px 0;
    }

    .footer_02 .footer_under_inner {
        width: 100%;
        max-width: 1200px;
        margin: 0 auto;
        display: flex;
    ...
    @media screen and (max-width: 768px) {
        ...
        .footer_02 .footer_list .wm_login_btn,
        .footer_list .wm_signup_btn {
            padding: 5px 0;
        }
    ...
    <div class="footer_main">
        <div class="footer_main_inner">
            ...
            <div class="footer_main_02">
                ...
                <div class="footer_item"><a href="https://fanreturn.com/fanding/my_project/project">プロジェクトを作る</a></div>
            </div>

            <div class="footer_main_03">
                <h4 class="footer_tit">fanreturnについて</h4>

                <div class="footer_item"><a href="https://fanreturn.com/fanding/terms_of_service">利用規約</a></div>
                <div class="footer_item"><a href="https://fanreturn.com/fanding/ps_terms_of_service">プロジェクトサポーター利用規約</a></div>
                <div class="footer_item"><a href="https://fanreturn.com/fanding/privacy_policy">プライバシーポリシー</a></div>
                <div class="footer_item"><a href="https://fanreturn.com/fanding/trade_law">特定商取引法に基づく表記</a></div>
                <div class="footer_item"><a href="https://fanreturn.com/fanding/inquiry/create">お問い合わせ</a></div>
    ...
    <div class="footer_under">
        <div class="footer_under_inner">
            <div class="footer_logo">
                <img class="h_logo_css" src="https://fanreturn.com/fanding/image/logo-color.svg">
            </div>
