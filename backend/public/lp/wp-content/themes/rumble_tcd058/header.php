        ...
        <header id="js-header" class="l-header<?php if ($dp_options['show_header_search'] && get_query_var('s')) echo ' is-header-search-active'; ?>">
            ...
            <div class="p-header__logo<?php if ($header_ad_html) echo ' has-ad'; ?>" style="display: none;">
                <div class="l-inner">
                    ...
                    ?>
                        <<?php echo $thisTag; ?> class="p-logo p-logo__header<?php if ($dp_options['header_logo_image_retina']) {
                                                                                    echo ' p-logo__header--retina';
                                                                                } ?>">
            ...
            <nav class="p-header__gnav l-header__bar">
					...
					<li id="gb_menu-item-2" class="gb_menu-item gb_menu-item-2 nav_btn m_t_2 under_arrow_yes">
						...
						<ul class="sub-gb_menu sub-gb_menu_02" style="display:none;">
							<li id="gb_menu-item-2_ko_01" class="gb_menu-item_normal header_serch_box">
								<img src="<?php //echo get_template_directory_uri();
                                            ?>/img/search_icon.svg" alt="" /><input type="search" class="hsinp" name="s" placeholder="クラファンを検索" value="">
                ...
                <style>
                    ...
                    * {
                    ...
                    .p-gb_global-nav .gb_menu-item-has-children:hover>.sub-gb_menu {
                        opacity: 1;
                        visibility: visible;
                    }

                    .p-gb_global-nav>li.gb_menu-item-has-children:hover>.sub-gb_menu {
                        left: 0;
                    }
                    ...
                    .p-gb_global-nav .sub-gb_menu a:hover {
                        opacity: 0.85;
                    }
                    ...
                    @media screen and (max-width: 991px) {
                        ...
                        #gb_nav-tgl_clone:checked+.open {
                            background: transparent;
                            transform: translateX(0px);
                        }

                        #gb_nav-tgl_clone:checked+.open span {
                            transform: scaleX(0);
                        }

                        #gb_nav-tgl_clone:checked+.open::before {
                            transform: rotate(45deg);
                            width: 80%;
                        }

                        #gb_nav-tgl_clone:checked+.open::after {
                            transform: rotate(-45deg);
                        }
                        ...
                        #gb_nav-tgl:checked~.drower-gb_menu {
                            transform: none;
                        }
                        ...
                        .p-gb_global-nav .gb_menu-item .sub-gb_menu a {
                            display: none;
                            opacity: 0;
                        }

                        .p-gb_global-nav .gb_menu-item input[type=checkbox]:checked+.sub-gb_menu a {
                            display: block;
                            opacity: 1;
                        }
                        ...
                        #gb_nav-tgl_clone:checked~.close {
                            pointer-events: auto;
                    ...
                    .menuset_05 {
                        border: solid 1px #00AEBD;
                        margin: 0 15px;
                        border-radius: 7px;
                    }

                    .menuset_05 .nav_btn_link {
                ...
                ?>
                        <div id="p-megamenu--<?php echo esc_attr($menu_id) ?>" class="p-megamenu p-megamenu--<?php echo esc_attr($value['type']); ?><?php
                            ...
                            <ul class="l-inner p-megamenu__bg">
                                ...
                                ?>
                                        <li<?php echo $li_class; ?>><a class="p-hover-effect--<?php echo esc_attr($dp_options['hover_type']); ?>" href="<?php echo get_category_link($category->term_id); ?>">
                                                <div class="p-megamenu__image p-hover-effect__image js-object-fit-cover"><img src="<?php echo esc_attr($image_src); ?>" alt=""></div><?php echo esc_html($category->name); ?>
                                            </a></li>
                                        <?php
                                            ...
                                            <li<?php if (!$cnt) echo ' class="is-active"'; ?>>
                                                ...
                                                ?>
                                                    <ul class="sub-menu p-megamenu__bg">
                                                        ...
                                                        ?>
                                                                <li><a class="p-hover-effect--<?php echo esc_attr($dp_options['hover_type']); ?>" href="<?php echo get_permalink($megamenu_post); ?>">
                                                                        <div class="p-megamenu__image p-hover-effect__image js-object-fit-cover"><img src="<?php echo esc_attr($image_src); ?>" alt=""></div><?php echo mb_strimwidth(strip_tags(get_the_title($megamenu_post)), 0, 50, '...'); ?>
                                                                    </a></li>
                                                            <?php
                                                            endforeach;
                                                        endif;
                                                        ...
                                                        if ($native_ad) :
                                                            ...
                                                            ?>
                                                            <li><a class="p-hover-effect--<?php echo esc_attr($dp_options['hover_type']); ?>" href="<?php echo esc_attr($native_ad['native_ad_url']); ?>" targer="_blank">
                                                                    <div class="p-megamenu__image p-hover-effect__image"><img src="<?php echo esc_attr($image_src); ?>" alt=""><?php if ($native_ad['native_ad_label']) : ?><div class="p-float-native-ad-label__small"><?php echo esc_html($native_ad['native_ad_label']); ?></div><?php endif; ?></div>
                                                                    <?php echo esc_html(mb_strimwidth($native_ad['native_ad_title'], 0, 50, '...')); ?>
                                                                </a></li>
                                                        <?php
                                                        endif;
                                                        ?>
