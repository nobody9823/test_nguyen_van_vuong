...
?>
		...
		<div class="tcdw_ad_widget_box_wrap">
<?php for ( $i = 1; $i <= 3; $i++ ) : ?>
			<h3 class="tcdw_ad_widget_headline"><?php _e( 'AdSense','tcd-w' ); ?><?php echo $i; ?></h3>
			<div class="tcdw_ad_widget_box">
				<div class="tcdw_ad_widget_box_inner">
					<h4 class="tcdw_ad_widget_sub_headline"><?php _e( 'Register AdSense code','tcd-w' ); ?></h4>
				...
				<div class="tcdw_ad_widget_box_inner">
					<h4 class="tcdw_ad_widget_sub_headline"><?php _e( 'Register AdSense image', 'tcd-w' ); ?></h4>
				...
				<div class="tcdw_ad_widget_box_inner">
					<h4 class="tcdw_ad_widget_sub_headline"><?php _e( 'Register affiliate code or link url for registered image', 'tcd-w' ); ?></h4>
