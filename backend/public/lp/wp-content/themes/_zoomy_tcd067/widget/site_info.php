...
?>
		...
		<div class="widget-sns-fields" style="display:<?php echo $instance['use_sns_theme_options'] ? 'none' : 'block'; ?>;">
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'youtube_url' ); ?>"><?php _e( 'Google+ URL', 'tcd-w' ); ?>:</label>
...
<?php
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['googleplus_url'] = wp_unslash( wp_filter_nohtml_kses( $new_instance['googleplus_url'] ) );
