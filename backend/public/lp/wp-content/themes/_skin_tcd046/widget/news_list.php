...
class tcdw_news_list_widget extends WP_Widget {
 ...
 function __construct() {
   parent::__construct(
     'tcdw_news_list_widget',// ID
     __( 'News list (tcd ver)', 'tcd-w' ),
     array(
       'classname' => 'tcdw_news_list_widget',
       'description' => __('Displays news list.', 'tcd-w')
     )
   );
 }
...
<?php
  ...
  <a class="archive_link" href="<?php echo get_post_type_archive_link('news'); ?>"><?php _e('Archive page', 'tcd-w'); ?></a>
  <?php }; ?>
