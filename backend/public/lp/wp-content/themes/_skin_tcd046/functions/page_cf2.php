...
function show_page_meta_box() {
  ...
  //フォントサイズ
  $font_size = array( 'name' => __('Font size', 'tcd-w'), 'desc' => '', 'id' => 'page_headline_font_size', 'type' => 'input', 'std' => '28' );
  ...
  echo '<dd class="content"><p class="desc">' , __('Register image for page header.<br />Recommend image size. Width:1280px, Height:320px', 'tcd-w') , '</p>';
  ...
  echo '<dd class="content"><input type="text" name="', $font_color['id'], '" id="', $font_color['id'], '" value="', $font_color_meta ? $font_color_meta : $font_color['std'], '" size="30" class="color" />';
?>
<input type="button" style="margin:0 0 0 5px;" class="button-secondary" value="<?php _e('Default color', 'tcd-w');  ?>" onClick="document.getElementById('<?php echo $font_color['id']; ?>').color.fromString('FFFFFF')"></dd>
<?php
  echo '</dd>';
  ...
  echo '<dd class="content"><input type="text" name="', $shadow4['id'], '" id="', $shadow4['id'], '" value="', $shadow4_meta ? $shadow4_meta : $shadow4['std'], '" size="30" class="color" />';
?>
<input type="button" style="margin:0 0 0 5px;" class="button-secondary" value="<?php _e('Default color', 'tcd-w');  ?>" onClick="document.getElementById('<?php echo $shadow4['id']; ?>').color.fromString('333333')"></dd>
<?php
  echo '</dd>';
