...
<div class="form-field column-filter" data-column="<?php echo esc_attr($i); ?>"<?php echo $style; ?>>
	...
	<table style="margin-top:5px;">
		<tr>
			...
			<td>
				<input type="text" id="pb_business_day-<?php echo esc_attr($values['widget_index']); ?>-column_headline_color<?php echo esc_attr($i); ?>" name="pagebuilder[widget][<?php echo esc_attr($values['widget_index']); ?>][column_headline_color<?php echo esc_attr($i); ?>]" value="<?php echo esc_attr($values['column_headline_color'.$i]); ?>" class="pb-input-narrow pb-wp-color-picker" data-default-color="<?php echo esc_attr($default_values['column_headline_color'.$i]); ?>" />
			</td>
		</tr>
		<tr>
			<td><?php _e('Background color', 'tcd-w'); ?></td>
			<td>
				<input type="text" id="pb_business_day-<?php echo esc_attr($values['widget_index']); ?>-column_headline_bg<?php echo esc_attr($i); ?>" name="pagebuilder[widget][<?php echo esc_attr($values['widget_index']); ?>][column_headline_bg<?php echo esc_attr($i); ?>]" value="<?php echo esc_attr($values['column_headline_bg'.$i]); ?>" class="pb-input-narrow pb-wp-color-picker" data-default-color="<?php echo esc_attr($default_values['column_headline_bg'.$i]); ?>" />
			</td>
		</tr>
	</table>
</div>
...
function display_page_builder_widget_business_day($values = array(), $widget_index = null) {
	...
	if (function_exists('get_desing_plus_option')) {
		...
		$title_bg_theme_option_key = apply_filters('page_builder_business_day_title_bg_theme_option_key', 'pickedcolor1');
