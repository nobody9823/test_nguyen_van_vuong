...
class PlanTest extends TestCase
{
    ...
    {
        $response = $this->actingAs($this->admin, 'admin')
        ->get(route('admin.plan.create', ['project' => $this->projects[0]]));
    ...
    public function testStoreAction()
    {
        ...
        $response = $this->actingAs($this->admin, 'admin')
            ->from(route('admin.plan.create', ['project' => $this->projects[0]]))
            ->post(route('admin.plan.store', ['project' => $this->projects[0]]), $data);
    ...
    public function testShowAction()
    {
        ...
        $response = $this->actingAs($this->admin, 'admin')
            ->get(route('admin.plan.show', ['plan' => $this->plans[0]]));
    ...
    public function testEditAction()
    {
        ...
        $response = $this->actingAs($this->admin, 'admin')
            ->get(route('admin.plan.edit', ['project' => $this->projects[0], 'plan' => $this->plans[0]]));
    ...
    public function testUpdateAction()
    {
        ...
        $response = $this->actingAs($this->admin, 'admin')
            ->from(route('admin.plan.edit', ['project' => $this->projects[0], 'plan' => $this->plans[0]]))
            ->patch(route('admin.plan.update', ['project' => $this->projects[0], 'plan' => $this->plans[0]]), $data);
    ...
    {
        $response = $this->actingAs($this->admin, 'admin')
            ->from(route('admin.plan.search', ['project' => $this->projects[0]]))
            ->delete(route('admin.plan.destroy', ['plan' => $this->plans[0]]));
    ...
    public function testSearchAction()
    {
        ...
        $response = $this->actingAs($this->admin, 'admin')
            ->from(route('admin.plan.index'))
            ->get(route('admin.plan.search', ['word' => 'test']));
    ...
    public function testDeleteImageAction()
    {
        $response = $this->actingAs($this->admin, 'admin')
            ->from(route('admin.plan.edit', ['project' => $this->projects[0], 'plan' => $this->plans[0]]))
            ->json('DELETE', route('admin.plan_image.destroy', ['plan' => $this->plans[0]]));
    ...
    public function testDeleteOptionAction()
    {
        $response = $this->actingAs($this->admin, 'admin')
            ->from(route('admin.plan.edit', ['project' => $this->projects[0], 'plan' => $this->plans[0]]))
            ->json('DELETE', route('admin.option.destroy', ['option' => $this->options[0]]));
