...
class PlanTest extends TestCase
{
    ...
    {
        $response = $this->actingAs($this->talent, 'talent')
        ->get(route('talent.plan.index'));
    ...
    {
        $response = $this->actingAs($this->talent, 'talent')
        ->get(route('talent.plan.create', ['project' => $this->projects[0]]));
    ...
    public function testStoreAction()
    {
        ...
        $response = $this->actingAs($this->talent, 'talent')
            ->from(route('talent.plan.create', ['project' => $this->projects[0]]))
            ->post(route('talent.plan.store', ['project' => $this->projects[0]]), $data);
    ...
    public function testShowAction()
    {
        ...
        $response = $this->actingAs($this->talent, 'talent')
            ->get(route('talent.plan.show', ['plan' => $this->plans[0]]));
    ...
    public function testEditAction()
    {
        ...
        $response = $this->actingAs($this->talent, 'talent')
            ->get(route('talent.plan.edit', ['project' => $this->projects[0], 'plan' => $this->plans[0]]));
    ...
    public function testUpdateAction()
    {
        ...
        $response = $this->actingAs($this->talent, 'talent')
            ->from(route('talent.plan.edit', ['project' => $this->projects[0], 'plan' => $this->plans[0]]))
            ->patch(route('talent.plan.update', ['project' => $this->projects[0], 'plan' => $this->plans[0]]), $data);
    ...
    {
        $response = $this->actingAs($this->talent, 'talent')
            ->from(route('talent.plan.search', ['project' => $this->projects[0]]))
            ->delete(route('talent.plan.destroy', ['plan' => $this->plans[0]]));
    ...
    public function testSearchAction()
    {
        ...
        $response = $this->actingAs($this->talent, 'talent')
            ->from(route('talent.plan.index'))
            ->get(route('talent.plan.search', ['word' => 'test']));
    ...
    public function testDeleteImageAction()
    {
        $response = $this->actingAs($this->talent, 'talent')
            ->from(route('talent.plan.edit', ['project' => $this->projects[0], 'plan' => $this->plans[0]]))
            ->json('DELETE', route('talent.plan_image.destroy', ['plan' => $this->plans[0]]));
    ...
    public function testDeleteOptionAction()
    {
        $response = $this->actingAs($this->talent, 'talent')
            ->from(route('talent.plan.edit', ['project' => $this->projects[0], 'plan' => $this->plans[0]]))
            ->json('DELETE', route('talent.option.destroy', ['option' => $this->options[0]]));
