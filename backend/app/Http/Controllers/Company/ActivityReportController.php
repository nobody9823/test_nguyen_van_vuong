...
class ActivityReportController extends Controller
{
    ...
    {
        $activity_reports = ActivityReport::getActivityReportsByCompany()->with('project')->paginate(10);
        return view('company.activity_report.index', [
            'project' => null,
    ...
    {
        return view('company.activity_report.create', ['project' => $project]);
    }
    ...
    public function store(ActivityReportRequest $request, ActivityReport $activity_report, Project $project)
    {
        ...
        $activity_reports = ActivityReport::getActivityReportsByCompany($project->id)->with('project')->paginate(10);
    ...
    {
        return view('company.activity_report.show', ['activity_report' => $activity_report]);
    }
    ...
    {
        return view('company.activity_report.edit', [
            'project' => $project,
