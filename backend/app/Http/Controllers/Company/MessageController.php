...
class MessageController extends Controller
{
    ...
    {
        $chating_messages = UserPlanCheering::with('messageContents')->getMessageByCompany()->wordSearch()->messaging()->orderBy('updated_at', 'desc')->get();
        $not_chating_messages = UserPlanCheering::with('messageContents')->getMessageByCompany()->wordSearch()->notMessaging()->orderBy('updated_at', 'desc')->get();
        return view('company.message.index', [
    ...
    {
        $this->authorize('checkOwnedByCompany', $user_plan_cheering);
        $send_message_check = $this->message_store($request, $user_plan_cheering, 'company');
    ...
    {
        $this->authorize('checkOwnedByCompany', $message);
    ...
    // {
    //     $this->authorize('checkOwnedByCompany', $message_content);
    //     DB::beginTransaction();
    //     try {
